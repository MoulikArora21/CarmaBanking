...
<head>
    ...
    <title>Card Management - CARMA Banking</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* Card Container */
        .card-display-container { display: grid; grid-template-columns: 1fr 1fr; gap: 32px; max-width: 1200px; margin: 0 auto; }
        ...
        .settings-title { font-size: 24px; font-weight: 700; color: #2d3748; margin-bottom: 24px; }
        .setting-item { display: flex; justify-content: space-between; align-items: center; padding: 16px 0; border-bottom: 1px solid #e2e8f0; }
        .setting-item:last-child { border-bottom: none; }
        .setting-label { font-size: 14px; font-weight: 500; color: #4a5568; }
        .setting-value { font-size: 14px; color: #718096; }
        ...
        /* Action Buttons */
        .card-actions { margin-top: 24px; display: flex; flex-direction: column; gap: 12px; }
        .btn-primary { padding: 14px 24px; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; border: none; border-radius: 8px; font-size: 14px; font-weight: 600; cursor: pointer; transition: all 0.2s; text-align: center; }
        .btn-primary:hover { transform: translateY(-1px); box-shadow: 0 4px 12px rgba(102, 126, 234, 0.4); }
        .btn-secondary { padding: 14px 24px; background: white; color: #667eea; border: 1px solid #667eea; border-radius: 8px; font-size: 14px; font-weight: 600; cursor: pointer; transition: all 0.2s; text-align: center; }
        .btn-secondary:hover { background: #f7fafc; }

        @media (max-width: 1024px) {
            .card-display-container { grid-template-columns: 1fr; }
        }
...
<body>
    ...
    <div class="container">
        <div class="page-header">
            ...
            <p class="page-subtitle">Manage your debit card settings and security preferences</p>
        </div>
        ...
        <div class="card-display-container">
            ...
            <div class="settings-section">
                ...
                <div class="setting-item">
                    <div>
                        <div class="setting-label">Card Status</div>
                    </div>
                ...
                <div class="setting-item">
                    <div>
                        <div class="setting-label">Contactless Payments</div>
                    </div>
                    <label class="toggle-switch">
                        <input type="checkbox" checked>
                        <span class="toggle-slider"></span>
                ...
                <div class="setting-item">
                    <div>
                        <div class="setting-label">Online Payments</div>
                    </div>
                    <label class="toggle-switch">
                        <input type="checkbox" checked>
                        <span class="toggle-slider"></span>
                ...
                <div class="setting-item">
                    <div>
                        <div class="setting-label">International Transactions</div>
                    </div>
                    <label class="toggle-switch">
                        <input type="checkbox">
                        <span class="toggle-slider"></span>
                ...
                <div class="setting-item">
                    ...
                    <div class="setting-value">5000 EUR</div>
                </div>
