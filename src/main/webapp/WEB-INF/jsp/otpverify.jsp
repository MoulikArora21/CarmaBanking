...
<head>
    ...
    <title>OTP Verification - CARMA Banking</title>
...
<body>
    ...
    <div class="container">
        ...
        <p class="subtitle">An OTP has been sent to your registered phone <strong>${phoneNumber}</strong> and email <strong>${email}</strong></p>
        <form action="/otpverify" method="post" id="otp-form" novalidate>
            <input type="hidden" name="username" value="${username}">
            <input type="text" class="otp-input" name="otp" placeholder="Enter OTP" required autocomplete="off">
