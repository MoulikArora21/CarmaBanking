...
<head>
    ...
    <style>
        * {
        ...
        /* Placeholder Message (when iframe is empty) */
        .placeholder-message {
            display: flex;
            flex-direction: column;
            align-items: center;
...
<div class="container">
    ...
    <div class="chat-container">
        ...
        <div class="iframe-container">
            <!--
                INSTRUCTIONS TO EMBED YOUR THESIS CHATBOT:
                1. Replace the src attribute below with your chatbot URL
                2. If your chatbot is at moulikarora.tech, use: src="https://moulikarora.tech"
                3. Make sure your chatbot website allows iframe embedding (X-Frame-Options header)

                Example:
                <iframe id="chatbot-iframe" src="https://moulikarora.tech" title="CARMA Support Chatbot"></iframe>
            -->

            <!-- Placeholder message (remove this when you add your iframe) -->
            <div class="placeholder-message">
                <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M8 10.5H16M8 14.5H11M21 12C21 16.9706 16.9706 21 12 21C10.2305 21 8.57674 20.4574 7.19762 19.5235L3 21L4.47647 16.8024C3.54258 15.4233 3 13.7695 3 12C3 7.02944 7.02944 3 12 3C16.9706 3 21 7.02944 21 12Z"
                          stroke="#667eea" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
                <h3>Chatbot Integration</h3>
                <p>
                    To embed your thesis chatbot, edit the <code>chat-support.jsp</code> file and
                    add your chatbot URL to the iframe src attribute.
                </p>
                <p style="margin-top: 20px; font-size: 14px;">
                    File location: <code>/src/main/webapp/WEB-INF/jsp/chat-support.jsp</code>
                </p>
            ...
            <!--
                Uncomment the iframe below and add your chatbot URL:
                <iframe id="chatbot-iframe" src="YOUR_CHATBOT_URL_HERE" title="CARMA Support Chatbot"></iframe>
            -->
        </div>
    </div>
</div>
