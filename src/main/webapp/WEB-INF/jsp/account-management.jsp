...
<head>
    ...
    <title>Account Management - CARMA Banking</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* Sections */
        .section { background: white; border-radius: 16px; margin-bottom: 16px; box-shadow: 0 2px 8px rgba(0,0,0,0.06); border: 1px solid #e2e8f0; overflow: hidden; }
        .section-header { padding: 20px 24px; cursor: pointer; display: flex; justify-content: space-between; align-items: center; transition: background 0.2s; }
        .section-header:hover { background: #f7fafc; }
        .section-header h3 { font-size: 18px; font-weight: 600; color: #2d3748; }
        .arrow { transition: transform 0.3s; color: #667eea; font-size: 20px; }
        ...
        .detail-label { font-size: 12px; font-weight: 600; color: #718096; text-transform: uppercase; letter-spacing: 0.5px; }
        .detail-value { font-size: 16px; color: #2d3748; font-weight: 500; }

        .action-buttons { display: flex; gap: 12px; justify-content: flex-end; padding-top: 16px; border-top: 1px solid #e2e8f0; }
        .btn-icon { padding: 10px; background: #f7fafc; border: 1px solid #e2e8f0; border-radius: 8px; cursor: pointer; transition: all 0.2s; display: flex; align-items: center; gap: 8px; }
        .btn-icon:hover { background: #edf2f7; border-color: #667eea; }

        /* Reports */
        .date-inputs { display: grid; grid-template-columns: 1fr 1fr; gap: 16px; margin-bottom: 16px; }
        ...
        /* Simple Sections */
        .simple-section { display: flex; justify-content: space-between; align-items: center; }
        .simple-section p { color: #4a5568; font-size: 16px; }
...
<body>
    ...
    <div class="container">
        ...
        <div class="section">
            <div class="section-header" onclick="window.location.href='/terms'">
