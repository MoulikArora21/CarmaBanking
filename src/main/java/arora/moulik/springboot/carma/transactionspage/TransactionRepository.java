...
public interface TransactionRepository extends JpaRepository<Transaction, Long> {
    ...
    @Query(value = "SELECT * FROM transaction t " +
            "WHERE t.sender_username = :senderUsername " +
            "OR t.recipient_username = :recipientUsername " +
            "ORDER BY t.date DESC", nativeQuery = true)
    List<Transaction> findBySenderUsernameOrRecipientUsername(@Param("senderUsername") String senderUsername,
